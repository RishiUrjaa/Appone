   <footer class="footer">
            <!-- Footer Top -->
               <?php
      $web_data = $this->db->query("select google_play_app_link,ios_app_link,facebook_link,instagram_link,twitter_link,linkedin_link,address,support_email,helpline_number from settings where id = 1")->row();
                     ...
                     <div class="row">
                        <div class="col-md-6 col-lg-6">
                           <div class="copyright-text">
                              <p class="mb-0">&copy; 2021 Astrohelp24. All rights reserved.</p>
                           </div>
                        </div>
                        <div class="col-md-6 col-lg-6">
                           <!-- Copyright Menu -->
