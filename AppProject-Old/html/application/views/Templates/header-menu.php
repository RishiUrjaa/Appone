               ...
               <div class="main-menu-wrapper">
                  ...
                  <ul class="main-nav">
                     ...
                     <li class="has-submenu">
                        ...
                        <ul class="submenu">
                           <li><a href="<?php echo base_url();?>home/astrologer_list">Consult Astrologer</a></li>
                           <li><a href="<?php echo base_url();?>home/astrologer_list">Ask a question</a></li>
                           <li class="has-submenu">
                              <a href="#">Report</a>
                              <ul class="submenu">
                                 <li><a href="<?php echo base_url();?>home/career_report">Career Report</a></li>
                                 <li><a href="<?php echo base_url();?>home/career_report">Education Report</a></li>
                                 <li><a href="<?php echo base_url();?>home/career_report">Marriage Report</a></li>
                                 <li><a href="<?php echo base_url();?>home/career_report">Love Report</a></li>
                                 <li><a href="<?php echo base_url();?>home/career_report">Child Report</a></li>
                                 <li><a href="<?php echo base_url();?>home/career_report">Business Report</a></li>
                                 <li><a href="<?php echo base_url();?>home/career_report">Foreign Report</a></li>
                                 <li><a href="<?php echo base_url();?>home/career_report">Property Report</a></li>
                              </ul>
                           </li>
                           <li class="has-submenu">
                              <a href="#">Courses</a>
                              <ul class="submenu">
                                 ...
                                 <li><a href="<?php echo base_url();?>home/astrology_course">Tarot Course</a></li>
                                 <li><a href="<?php echo base_url();?>home/astrology_course">Vastu Course</a></li>
                                 <li><a href="<?php echo base_url();?>home/astrology_course">Palmistry Course</a></li>
                              </ul>
                           </li>
                           <li class="has-submenu">
                              ...
                              <ul class="submenu">
                                 ...
                                 <li><a href="<?php echo base_url();?>home/office_vastu">Industrial Vastu</a></li>
                              </ul>
                           </li>
                           <li><a href="<?php echo base_url();?>home/horoscopes">Free Horoscope</a></li>
                           <li><a href="<?php echo base_url();?>home/horoscopes">Marriage Matching</a></li>
                           <li><a href="<?php echo base_url();?>home/horoscopes">Numerology</a></li>
                           <li><a href="<?php echo base_url();?>home/horoscopes">Today's Panchang</a></li>
                        </ul>
                     </li>
                     <li class="">
                        <a href="<?php echo base_url();?>sdauth/filter_astrologers" class="highlight">Consult Astrologers</a>
                        <!-- <a href="<?php echo base_url();?>home/astrologer_list" class="highlight">Consult Astrologers</a> -->
                     </li>
                     <!--  <li class="">
                        <a href="#">Horoscopes</a>
                          </li> -->
