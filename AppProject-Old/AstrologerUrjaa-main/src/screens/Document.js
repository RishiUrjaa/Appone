...
const Document = ({navigation}) => {
  ...
  return (
    <SafeAreaProvider style={globStyle.safeAreaView}>
      <StatusBarDark />
      {SimpleHeader('Document', () => navigation.goBack())}
      <ScrollView>
        <View
          style={{
        ...
        <View style={{flexDirection: 'row'}}>
          <Image
            ...
            source={{uri: user.aadhar_card_front_image}}
          />

          <Image
            style={{width: '45%', height: 200, marginLeft: 10}}
            source={{uri: user.aadhar_card_back_image}}
          />
        </View>
        ...
        <Image
          style={{width: '45%', height: 200}}
          source={{uri: user.pan_card_image}}
        />
      </ScrollView>
    </SafeAreaProvider>
  );
