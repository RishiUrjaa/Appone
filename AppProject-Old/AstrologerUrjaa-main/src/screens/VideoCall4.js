...
const On = () => require('../assets/btn_endcall.png');
...
class OperateButton extends PureComponent {
  render() {
    const {
      ...
      source,
      style,
      imgStyle = {width: 40, height: 40, resizeMode: 'contain', marginTop: 6},
    } = this.props;
    return (
...
class VideoCall4 extends Component<Props> {
  state = {
    peerIds: [],
    joinSucceed: false,
    isMute: false,
      ...
      <Surface
            ...
            <View style={{flexDirection: 'row'}}>
              ...
              <View style={{marginTop: 1, height: 30, marginLeft: -20}}>
                ...
                <View
                  ...
                  <View style={{flexDirection: 'row', height: 30}}></View>
                </View>
              </View>
            </View>
          </View>
        ...
        <View
          ...
          <Text
            ...
            Name:{this.props.route.params.user_member.name}
          </Text>
          <Text
            style={{
              color: 'black',
            ...
            Gender:{this.props.route.params.user_member.gender}
          </Text>
          <Text
            style={{
              color: 'black',
            ...
            Pob:{this.props.route.params.user_member.pob}
          </Text>
          <Text
            style={{
              color: 'black',
            ...
            Dob:{this.props.route.params.user_member.dob}
          </Text>
          <Text
            style={{
              color: 'black',
            ...
            Tob:{this.props.route.params.user_member.tob}
          </Text>
        </View>
