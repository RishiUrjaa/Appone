            ...
            <div class="container-fluid">
               <div class="row align-items-center">
                  <div class="col-md-12 col-12">
                     ...
                     <h2 class="breadcrumb-title"><?php echo $page_title; ?>
</h2>
                  </div>
               </div>
            </div>
                  ...
                  <div class="col-md-6 col-lg-7">
                    ...
                    <div class="col-md-6 col-lg-5 theiaStickySidebar">
                     ...
                     <div class="card booking-card">
                        <div class="card-header">
                           <h4 class="card-title">View Your <?php echo $page_title; ?> Price : <span id='horoscope_price'></span><br/></h4>
                        </div>
                        <form method="post">
                        <div class="card-body">
                            <div class="row">
                                          ...
                                          <div class="form-group card-label">
                                             ...
                                             <select class="form-control" name="astrologer" id='sel_astrologer'>
                                               <option value="0">Select Astrologer</option>
                                                <?php
                                                $as = $this->db->query("select * from skills where speciality_id = 23 AND horoscope_price >1")->result();
                                                // print_r($as); die;
                                       ...
                                       <div class="col-md-12">
                                          <div class="form-group card-label">
                                             ...
                                             <input class="form-control astro_price" name="price" id="astro_price" value="" type="hidden">
                                          </div>
                                       </div>
  ...
  $(document).ready(function(){
   ...
   $('#sel_astrologer').change(function(){
    ...
    $.ajax({
     url:'<?=base_url()?>/home/astologer_education_peice_details',
     method: 'post',
