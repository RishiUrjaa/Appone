...
<li class="breadcrumb-item active" aria-current="page">Astrologer Profile</li>
  ...
  <img src="<?= BASE_URL_IMAGE.'astrologers/'.$astrologer_details->image ?>" class="img-fluid" style="border-radius: 50%;" alt="User Image">	
...
?>
   <p class="avi" style="margin: 10px 0px 0px 25px; color: red;">&nbsp;<i class="fa fa-circle" aria-hidden="true"></i>&nbsp;Busy <br>
           <span class="wait-time">Wait time ~ <?php echo $astrologer_details->wait_time; ?>min</span></p>
<?php
}
...
<p class="doc-speciality"><?=$specialty?></p>
    ...
    <!-- <div class="exper">
    	<?php 
		foreach ($astrologer_details->expertiesData as $experties_key ) 
		{
			?>
			  <p class="vedic-astro"><?php echo $experties_key->name ?></p>
			<?php
		}
		?>		
  	</div> -->
