            ...
            <div class="row">
               <div class="col-12">
                  ...
                  <div class="breadcrumb-content d-flex flex-column align-items-center text-center">
                     <h2 class="text-white text-capitalize">Company Registration</h2>
                     <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a class="text-uppercase text-white" href="<?php echo base_url(); ?>">Home</a></li>
                        <li class="breadcrumb-item text-white active">Company Registration</li>
                     </ol>
                  </div>
               </div>
            </div>
         ...
         <div class="register-page">
            <div class="container">
               ...
               <option data-countryCode="US" value="1">UK (+44)</option> -->
                        ...
                        <div class="col-sm-4 col-xs-12">
                           <div class="form-group">
                              <label class="upload">Company Name</label>
                        ...
                        <div class="col-sm-8 col-xs-12">
                           <div class="form-group">
                              <label class="upload">Company Address</label>
                              <input type="text" class="form-control" name="company_addesss" placeholder="Company Address" required="required">
                           </div>
                        </div>
                        ...
                        <div class="col-sm-4 col-xs-12">
                           <div class="form-group">
                              <label class="upload">Company type</label>
                              <select class="form-control" name="type" id='purpose'>
                        ...
                        <div class="col-sm-4 col-xs-12">
                           <div class="form-group">
                              <label class="upload">Category </label>
                              <select class="form-control" name="categary">
                                 ...
                                 <option value="Pyra Cards">Pyra Cards</option>
                        ...
                        <div style='display:none;' id='business'>
                           <div class="form-group">
                              <label class="upload">Company Plant Address</label>
                              <input type="text" class="form-control" name="company_plant_address" placeholder="Company Plant Address" >
                           </div>
                        </div>
                        </div>
                        ...
                        <button type="button" id="add-options" class="btn btn-purple btn-lg">Add Product</button>
                     </div>
                     <div class="row mt-4">
...
<div class="card-body">
                            <div class="row">
                                 <input type="hidden" name="options[]" class="options-cnt">
                                ...
                                <div class="col-4">
                                    <div class="form-group">
                                        ...
                                        <input id="price" type="text"  name="price"
                                               value="" required class="form-control option-pname">
                                    </div>
                                </div>
                                ...
                                <div class="col-4">
                                    <div class="form-group">
                                        ...
                                        <input id="price" type="number"  name="price"
                                               value="" required class="form-control option-price">
                                    </div>
                                </div>
                                ...
                                <div class="col-4">
                                    <div class="form-group">
                                        ...
                                        <input id="price" type="text" name="price"
                                               value="" required class="form-control option-desc">
                                    </div>
                                </div>
                                <div class="col-4">
                                    <div class="form-group">
                                        ...
                                        <input id="price" type="file" name="price"
                                               value="" required class="form-control option-image1">
                                    </div>
                                </div>
                                <div class="col-4">
                                    <div class="form-group">
                                        <label for="price">Image2</label>
                                        <input id="price" type="file" name="price"
                                               value=""  class="form-control option-image2">
                                    </div>
                                </div>
                                <div class="col-12">
                                    <button type="button" class="btn btn-purple btn-lg option-delete"><i class="fas fa-trash"></i></button>
                                </div>
                            </div>
</div>
</div>
      ...
      function setup() {
         $("#option-list .option-item").each(function(index, ele) {
            console.log(index)
            const id = "option-" + index;
            $(ele).attr("id", id)
            $("#" + id + " .options-cnt").attr("value", index)

          
            $("#" + id + " .option-pname").attr("name", "pname_" + index)
            $("#" + id + " .option-price").attr("name", "price_" + index)
            $("#" + id + " .option-desc").attr("name", "desc_" + index)
            $("#" + id + " .option-image1").attr("name", "image1_" + index)
            $("#" + id + " .option-image2").attr("name", "image2_" + index)

            $("#" + id + " .option-delete").attr("data-index", index)
         })
